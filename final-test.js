// ============================================
// TEST FINAL - Lecția 20 (A1.2): Neue Freunde! (Tranziție A2)
...
const finalTestData = [
    // 4× Prepoziție potrivită
    { type: 'multiple', category: '🟡 Prepoziție potrivită', question: 'Andreea kauft Blumen ____ ihre Mutter.', options: ['durch', 'gegen', 'ohne', 'für'], correct: 'für', explanation: 'für = pentru. Andreea cumpără flori PENTRU mama ei.' },
    { type: 'multiple', category: '🟡 Prepoziție potrivită', question: 'Florian läuft ____ den Baum. Aua!', options: ['für', 'gegen', 'durch', 'um'], correct: 'gegen', explanation: 'gegen = împotriva / contra. Aici cu sens fizic: se lovește DE copac.' },
    { type: 'luckentext', category: '🟡 Prepoziție potrivită', question: 'Completează:', sentence: 'Mihai arbeitet ____ nächste Woche an dem Projekt.', translation: 'Mihai lucrează la proiect până săptămâna viitoare.', accept: ['bis'], correct: 'bis', explanation: 'bis = până (la). Cu indicatori de timp (Woche, Monat, Freitag) FĂRĂ articol.' },
    { type: 'luckentext', category: '🟡 Prepoziție potrivită', question: 'Completează:', sentence: 'Annette joggt durch ____ Park.', translation: 'Annette aleargă prin parc.', accept: ['den'], correct: 'den', explanation: 'durch cere Akk → der Park → durch DEN Park (masculin).' },

    // 4× Articol Akk după prepoziție
    { type: 'multiple', category: '📝 Articol Akk', question: 'Welche Form ist KORREKT (corectă)?', options: ['für der Vater', 'für den Vater', 'für dem Vater', 'für des Vater'], correct: 'für den Vater', explanation: 'für + Akk masc → der → DEN. Doar masculinul singular își schimbă forma.' },
    { type: 'luckentext', category: '📝 Articol Akk', question: 'Completează (gegen + ein masc):', sentence: 'Carolina spielt Tennis gegen ____ Kollegen.', translation: 'Carolina joacă tenis împotriva unui coleg.', accept: ['einen'], correct: 'einen', explanation: 'gegen + Akk masc → ein → EINEN. Pattern complet din L5.' },
    { type: 'luckentext', category: '📝 Articol Akk', question: 'Completează (ohne + mein masc):', sentence: 'Andreea kommt ohne ____ Bruder.', translation: 'Andreea vine fără fratele meu.', accept: ['meinen'], correct: 'meinen', explanation: 'ohne + Akk masc → mein → MEINEN. Posesivul se declină ca ein.' },
    { type: 'multiple', category: '📝 Articol Akk', question: 'Care e CORECT pentru „prin grădina noastră"?', options: ['durch unser Garten', 'durch unserem Garten', 'durch unseren Garten', 'durch unsere Garten'], correct: 'durch unseren Garten', explanation: 'durch + Akk masc → unser → UNSEREN. der Garten = masculin.' },

    // 4× um vs gegen pentru ORĂ + um … herum
    { type: 'multiple', category: '⏰ um vs gegen', question: 'Pe la ora 8 (aproximativ) — care e CORECT?', options: ['um 8 Uhr', 'gegen 8 Uhr', 'für 8 Uhr', 'bis 8 Uhr'], correct: 'gegen 8 Uhr', explanation: 'gegen + oră = APROXIMATIV (poate 7:50, poate 8:15). um + oră = EXACT.' },
    { type: 'luckentext', category: '⏰ um vs gegen', question: 'Completează (la 9 fix):', sentence: 'Florian beginnt die Arbeit ____ 9 Uhr.', translation: 'Florian începe lucrul la ora 9 fix.', accept: ['um'], correct: 'um', explanation: 'Pentru oră FIXĂ/EXACTĂ → mereu um (recap L13).' },
    { type: 'luckentext', category: '⏰ um vs gegen', question: 'Completează (pattern um … herum):', sentence: 'Der Hund läuft um die Katze ____.', translation: 'Câinele aleargă în jurul pisicii.', accept: ['herum'], correct: 'herum', explanation: 'Pattern um + Akk + HERUM (opțional, dar des folosit pentru întărire).' },
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong> despre cele 6 prepoziții Akkusativ, capcana um vs gegen, articole + recap A1.</p>
